    ...
    <div className="h-full">
      <div className="h-full shadow-2xl">
        <div className="flex flex-col  w-screen h-full px-10 py-32 text-xl bg-indigo-500">
          ...
          <form className="w-full mx-auto my-auto items-center" onSubmit={handleRegister}>
            <div className="flex items-center bg-indigo-300 border-b border-indigo-500 rounded-t-lg">
              <label htmlFor="name" className="w-20 mr-8 ml-2 text-pink-100">Email</label>
            ...
            <div className="flex items-center mb-10  bg-indigo-300 rounded-b-lg"><label htmlFor="twitter" className="w-20 mr-8 ml-2 text-pink-100">Password</label>
